...
public class Verifica extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setForeground(new java.awt.Color(75, 123, 125));
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/VERI.png"))); // NOI18N
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 300, -1, -1));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        String pregunta = EncriptarContrasena.md5(jtxtRespuesta.getText());
        if(jtxtNom.equals("")|| jtxtRespuesta.equals(""))
        JOptionPane.showMessageDialog(this,"Rellene todos los campos");
        else{
        
         Usuarios aut= new Usuarios();
         aut.setNomUsuario(jtxtNom.getText());
         aut.setRespuesta(pregunta);
         boolean rp= aut.VerificarContra();
